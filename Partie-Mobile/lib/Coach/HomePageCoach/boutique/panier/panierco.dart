...
class panier1co extends StatefulWidget {
  Produit prod;
  panier1co({Key? key, required this.prod}) : super(key: key);

  @override
  State<panier1co> createState() => _panier1coState();
}

class _panier1coState extends State<panier1co> {
            ...
            leading: IconButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          DetailProduitco(produit: widget.prod)));
                },
                icon: const Icon(
                      ...
                      Row(
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => const InfoLIvco()));
                            },
