...
class infoprevco extends StatefulWidget {
  const infoprevco({Key? key}) : super(key: key);

  @override
  State<infoprevco> createState() => _infoprevState();
}

class _infoprevState extends State<infoprevco> {
