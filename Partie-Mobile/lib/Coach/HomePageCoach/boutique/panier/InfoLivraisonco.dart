...
class InfoLIvco extends StatefulWidget {
  
  const InfoLIvco({Key? key}) : super(key: key);

  @override
  State<InfoLIvco> createState() => _InfoLIvState();
}

class _InfoLIvState extends State<InfoLIvco> {
    ...
    automaticallyImplyLeading: false,
     leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>  panier1co(prod: Produit())));
        },
         ...
         Center(
          ...
          Container(
            ...
            child: TextFormField(
                  ...
                  //                  Navigator.of(context).push(
                  // MaterialPageRoute(builder: (context)=> panier1co()));
