...
import 'package:app_parent/Coach/HomePageCoach/boutique/panier/SuccesPayco.dart';
import 'package:app_parent/Coach/payementco/infocartecoach.dart';
import 'package:flutter/material.dart';

class Codeco extends StatefulWidget {
  const Codeco({Key? key}) : super(key: key);

  @override
  State<Codeco> createState() => _CodeState();
}
class _CodeState extends State<Codeco> {
   @override
  ...
  decoration: InputDecoration(
      ...
      fillColor: Colors.white70),
        ...
        ElevatedButton(onPressed:() {
                   Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const Succesco()));
                 },
                            child: 
