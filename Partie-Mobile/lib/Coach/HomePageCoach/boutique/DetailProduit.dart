...
import 'package:app_parent/Coach/HomePageCoach/boutique/boutiqueco.dart';
import 'package:app_parent/Coach/HomePageCoach/boutique/panier/panierco.dart';
...
class DetailProduitco extends StatefulWidget {
  Produit produit;
  DetailProduitco({Key? key, required this.produit}) : super(key: key);

  @override
  State<DetailProduitco> createState() => _DetailProduitState();
}

class _DetailProduitState extends State<DetailProduitco> {
  ...
  var items1 = ['Taille', '37', '38', '39', '40', '41', '42', '43'];
  int _counter = 0;
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const boutiqueco()));
            },
            icon: const Icon(
              Icons.arrow_back,
              size: 25,
          ...
          child: Column(
            ...
            Padding(
                ...
                child: SizedBox(
                  ...
                  child: Image.memory(
                      Base64Decoder().convert(widget.produit.image.toString())),
                )),
            Padding(
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: 21.0),
                  child: Text(
                    widget.produit.idProduit.toString(),
