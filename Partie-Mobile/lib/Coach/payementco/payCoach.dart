...
import 'package:app_parent/Coach/payementco/mesinfopaycoach.dart';
import 'package:app_parent/Coach/payementco/miseajourcarteco.dart';
import 'package:flutter/material.dart';

class PayementCo extends StatefulWidget {
  const PayementCo({Key? key}) : super(key: key);

  @override
  State<PayementCo> createState() => _PayementState();
}

class _PayementState extends State<PayementCo> {
  @override
                    ...
                    Row(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Text("DATE DE RENOUVELLEMENT ",
                              style: TextStyle(
                                  fontSize: 12,
                                  fontFamily: 'Poppins',
                                  fontWeight: FontWeight.w400,
                            ...
                            Padding(
                              ...
                              child: Text("DATE DE RENOUVELLEMENT ",
                                  style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.w400,
                                      color:
                                          Color.fromARGB(255, 147, 146, 150))),
                            ),
                            Padding(
                              padding: EdgeInsets.only(right: 5.0, top: 10),
                              child: Text("01.21-2022",
                                  style: TextStyle(
                                      fontSize: 15,
                                      fontFamily: 'Poppins',
                                      fontWeight: FontWeight.w500,
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const ModepaiCo()));
                  },
                  child: const Text(
                    "Mise a jour mode de paiement",
                    style: TextStyle(
                        fontSize: 14,
                        fontFamily: 'Poppins',
                        fontWeight: FontWeight.w500),
                    ...
                    children: [
                      ...
                      Row(
                        children: const [
                          Padding(
                            ...
                            child: Text("Titulaire de la carte :",
                                style: TextStyle(
                                    fontSize: 10,
                                    fontFamily: 'Poppins',
                                    fontWeight: FontWeight.w500,
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => const mesinfoCo()));
                          },
                          child: const Text(
