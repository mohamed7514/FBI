...
class ModepaiCo extends StatefulWidget {
  const ModepaiCo({Key? key}) : super(key: key);

  @override
  State<ModepaiCo> createState() => _ModepaiState();
}

class _ModepaiState extends State<ModepaiCo> {
   @override
      ...
      automaticallyImplyLeading: false,
        leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const PayementCo()));
        },
