...
class PayPar extends StatefulWidget {
  const PayPar({Key? key}) : super(key: key);

  @override
  State<PayPar> createState() => _PayParState();
}

class _PayParState extends State<PayPar> {
   @override
      ...
      automaticallyImplyLeading: false,
        leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const InfoLIv()));
        },
        ...
        child: Column( 
          ...
          children: [
            ...
            Stack(children:[
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const infoprev()));
},
