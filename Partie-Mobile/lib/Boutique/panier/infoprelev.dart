...
class infoprev extends StatefulWidget {
  const infoprev({Key? key}) : super(key: key);

  @override
  State<infoprev> createState() => _infoprevState();
}

class _infoprevState extends State<infoprev> {
