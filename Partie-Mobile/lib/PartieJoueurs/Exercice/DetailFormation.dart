...
class DetailFormation extends StatefulWidget {
  // ignore: non_constant_identifier_names
  Formation formation;
  DetailFormation({Key? key, required this.formation}) : super(key: key);

  @override
  State<DetailFormation> createState() => _DetailFormationState();
}

// ignore: camel_case_types
class _DetailFormationState extends State<DetailFormation> {
  ...
  Future<List<Formation>> FetchFormation() async {
    ...
    if (request.statusCode == 200) {
      ...
      Systeme =
          List<Formation>.from(l.map((model) => Formation.fromJson(model)));
      return Systeme;
    } else {
      return Systeme;
    }
  ...
  Widget build(BuildContext context) {
    ...
    String image1 = widget.formation.image.toString();
      ...
      body: SingleChildScrollView(
          child: Column(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.formation.type.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
            ...
            Padding(
              padding: EdgeInsets.only(left: 22.0),
              child: Text(
                widget.formation.description.toString(),
                style: TextStyle(
                    fontFamily: 'Poppins',
                    fontSize: 14,
                    fontWeight: FontWeight.w700,
