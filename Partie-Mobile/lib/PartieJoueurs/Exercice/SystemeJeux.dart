...
import 'package:app_parent/PartieJoueurs/Exercice/DetailSysjeux.dart';
...
class SystemeJeuJou extends StatefulWidget {
  const SystemeJeuJou({Key? key}) : super(key: key);

  @override
  State<SystemeJeuJou> createState() => _SystemeJeuJouState();
}

class _SystemeJeuJouState extends State<SystemeJeuJou> {
  ...
  getSystemeJeu() async {
    futureData = await FetchSystemeJeu();
    setState(() {
      print(futureData);
    });
  }

  Future<List<SystemeJeu>> FetchSystemeJeu() async {
    List<SystemeJeu> midia = [];
    var headers = {
      'Authorization':
  ...
  @override
  Widget Acualite(SystemeJeu midi) {
    ...
    return
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => DetailSysjeuxJou(systemeJeu: midi)));
      },
      child: Container(
