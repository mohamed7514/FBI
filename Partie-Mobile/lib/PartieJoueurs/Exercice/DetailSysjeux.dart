...
class DetailSysjeuxJou extends StatefulWidget {
  // ignore: non_constant_identifier_names
  SystemeJeu systemeJeu;
  DetailSysjeuxJou({Key? key, required this.systemeJeu}) : super(key: key);

  @override
  State<DetailSysjeuxJou> createState() => _DetailSysjeuxJouState();
}

// ignore: camel_case_types
class _DetailSysjeuxJouState extends State<DetailSysjeuxJou> {
  ...
  Widget build(BuildContext context) {
    ...
    String image1 = widget.systemeJeu.image.toString();
      ...
      body: SingleChildScrollView(
          child: Column(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget.systemeJeu.nom.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.systemeJeu.auteur.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
            ...
            Padding(
              padding: EdgeInsets.only(left: 22.0),
              child: Text(
                widget.systemeJeu.description.toString(),
                style: TextStyle(
                    fontFamily: 'Poppins',
                    fontSize: 14,
                    fontWeight: FontWeight.w700,
