...
import 'package:app_parent/PartieJoueurs/boutique/panier/InfoLivraisonjou.dart';
...
class panier1Jou extends StatefulWidget {
  Produit prod;
  panier1Jou({Key? key, required this.prod}) : super(key: key);

  @override
  State<panier1Jou> createState() => _panier1JouState();
}

class _panier1JouState extends State<panier1Jou> {
  ...
  Widget Article(Produit prod) {
    ...
    String image1 = widget.prod.image.toString();
  ...
  Widget build(BuildContext context) {
    ...
    final screenHeight = MediaQuery.of(context).size.height;
    final screenWidth = MediaQuery.of(context).size.width;
    double total = widget.prod.prix! * 0.01 + widget.prod.prix!;
    return Scaffold(
            ...
            leading: IconButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          DetailProduitjou(produit: widget.prod)));
                },
                icon: const Icon(
                      ...
                      Row(
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => const InfoLIvjou()));
                            },
