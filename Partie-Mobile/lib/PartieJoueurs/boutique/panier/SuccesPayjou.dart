...
class Succesjou extends StatefulWidget {
  const Succesjou({Key? key}) : super(key: key);

  @override
  State<Succesjou> createState() => _SuccesState();
}
class _SuccesState extends State<Succesjou> {
   @override
