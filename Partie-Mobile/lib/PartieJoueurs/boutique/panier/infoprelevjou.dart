...
import 'package:app_parent/PartieJoueurs/boutique/panier/PaiementParjou.dart';
import 'package:app_parent/PartieJoueurs/boutique/panier/Profil/panier/ModePayjou.dart';
import 'package:app_parent/PartieJoueurs/boutique/panier/codejou.dart';
import 'package:flutter/material.dart';

class infoprevjou extends StatefulWidget {
  const  infoprevjou({Key? key}) : super(key: key);

  @override
  State< infoprevjou> createState() => _infoprevState();
}

class _infoprevState extends State< infoprevjou> {
      ...
      automaticallyImplyLeading: false,
        leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                 MaterialPageRoute(builder: (context)=> const PayParjou()));
        },
icon:const Icon(Icons.arrow_back_outlined,size: 25,)),  
    title: const Text('Information prélevement ',style: TextStyle(fontSize: 16 , fontFamily: 'Poppins',fontWeight: FontWeight.w500),),
    titleSpacing: 0.0,
     elevation: 0,
    centerTitle: true,
            ...
            Center(
              child: Container(
                ...
                child: TextFormField(
                          ...
                          decoration: const InputDecoration(
                            suffixIcon: 
                            Icon(Icons.credit_card_outlined,color: Color.fromARGB(255, 0, 73, 133),),
                          fillColor: Color.fromARGB(255, 226, 227, 244), 
                          filled: true,
                         labelText: "BIC*",
                  ...
                  MaterialPageRoute(builder: (context)=> const ModepaiJou()));
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(onPressed:() {
                           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const Codejou()));
                          },
                              child: 
