...
import 'package:app_parent/PartieJoueurs/boutique/panier/infoprelevjou.dart';
import 'package:app_parent/PartieJoueurs/boutique/panier/informationcartejou.dart';

import 'package:flutter/material.dart';


class PayParjou extends StatefulWidget {
  const PayParjou({Key? key}) : super(key: key);

  @override
  State<PayParjou> createState() => _PayParState();
}

class _PayParState extends State<PayParjou> {
   @override
      ...
      automaticallyImplyLeading: false,
        leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const InfoLIvjou()));
        },
        ...
        child: Column( 
          ...
          children: [
            ...
            Stack(children:[
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=> const infoprevjou()));
},
