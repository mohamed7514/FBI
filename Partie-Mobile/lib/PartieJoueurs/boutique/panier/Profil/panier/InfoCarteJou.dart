...
class InfoCarteJou extends StatefulWidget {
  const InfoCarteJou({Key? key}) : super(key: key);

  @override
  State<InfoCarteJou> createState() => _InfoCarteState();
}
 bool isChecked = false;
class _InfoCarteState extends State<InfoCarteJou> {
   @override
