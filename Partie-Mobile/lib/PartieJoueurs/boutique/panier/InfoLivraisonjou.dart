...
class InfoLIvjou extends StatefulWidget {
  
  const InfoLIvjou({Key? key}) : super(key: key);

  @override
  State<InfoLIvjou> createState() => _InfoLIvState();
}

class _InfoLIvState extends State<InfoLIvjou> {
    ...
    automaticallyImplyLeading: false,
     leading :IconButton(onPressed: (){
           Navigator.of(context).push(
                  MaterialPageRoute(builder: (context)=>  panier1Jou(prod:Produit())));
        },
