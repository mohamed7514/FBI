...
class DetailProduitjou extends StatefulWidget {
  Produit produit;
  DetailProduitjou({Key? key, required this.produit}) : super(key: key);

  @override
  State<DetailProduitjou> createState() => _DetailProduitState();
}

class _DetailProduitState extends State<DetailProduitjou> {
  ...
  Widget build(
    ...
    String image1 = widget.produit.image.toString();
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.produit.couleur.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.produit.categorie.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
              ...
              child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            panier1Jou(prod: widget.produit)));
                  },
