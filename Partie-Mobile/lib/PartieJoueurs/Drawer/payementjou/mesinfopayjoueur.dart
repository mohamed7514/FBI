...
class mesinfoJou extends StatefulWidget {
  const mesinfoJou({Key? key}) : super(key: key);

  @override
  State<mesinfoJou> createState() => _mesinfoState();
}

class _mesinfoState extends State<mesinfoJou> {
