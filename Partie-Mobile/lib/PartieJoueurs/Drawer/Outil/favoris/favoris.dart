...
class favorisJou extends StatefulWidget {
  const favorisJou({Key? key}) : super(key: key);

  @override
  State<favorisJou> createState() => _boutiqueState();
}

class _boutiqueState extends State<favorisJou> {
