...
class _detailMatchState extends State<detailMatch> {
  ...
  Future<List<Match>> FetchMatch() async {
    ...
    if (request.statusCode == 200) {
      ...
      product = List<Match>.from(l.map((model) => Match.fromJson(model)));
      return product;
    } else {
      return product;
    }
  ...
  Widget build(
    ...
    String image1 = widget.match.equipeAdversaire!.logo.toString();
      ...
      body: SingleChildScrollView(
          child: Column(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget.match.ligue!.nomLigue.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.match.equipeAdversaire!.nom.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.match.stade!.nom.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.match.stade!.adresse.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(right: 12.0),
                    child: Text(
                      widget.match.stade!.numeroTel.toString(),
                      style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
            ...
            Padding(
              ...
              child: Text(
                widget.match.stade!.email.toString(),
                style: TextStyle(
                    fontFamily: 'Poppins',
                    fontSize: 14,
                    fontWeight: FontWeight.w700,
